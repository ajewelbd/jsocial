...
export default function MainContent() {
    ...
    useEffect(() => {
        axios.get("posts").then(response => setPosts(response.data.data.map((post: Post) => ({ ...post, splitted_details: splitText(post.details) }))))
        document.querySelector<HTMLElement>("#posts")?.addEventListener("scrollend", ({ target }: any) => {
            console.log(456, target["scrollTop"])
        })
    }, [])
        ...
        <div className="p-4 sm:ml-64">
            <div className="flex flex-col gap-5 dark:border-gray-700 mt-11">
                <div className="flex">
                    ...
                    <div id="authentication-modal" tabIndex={1} aria-hidden="true" className={`${newPostModalVisibility ? "absolute" : "hidden"} top-5 left-3 right-0 z-50 w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full`}>
                                    ...
                                    <form>
                                        <div className="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
                                            <div className="px-4 py-2 bg-white rounded-t-lg dark:bg-gray-800">
                                                ...
                                                <textarea id="comment" rows={4} className="w-full px-0 text-sm text-gray-900 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Write your thoughts..." required></textarea>
                                            </div>
                ...
                <div className="flex">
                    <section className="flex flex-row flex-wrap mx-auto overflow-y-auto no-scrollbar" style={{ height: "calc(100vh - 150px)" }} id="posts">
